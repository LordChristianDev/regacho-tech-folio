        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {skillCategories.map((category, index) => {
            ...
            return (
              <Card 
                key={index} 
                className="group relative bg-white/5 backdrop-blur-sm border border-white/10 hover:border-white/20 transition-all duration-500 transform hover:-translate-y-2 hover:scale-105 overflow-hidden"
              >
                ...
                <CardContent className="p-8 relative z-10">
                  <div className="flex items-center mb-6">
                    ...
                    <h3 className="text-xl font-bold text-white ml-4 group-hover:text-white transition-colors duration-300">
                      {category.title}
                    </h3>
                  </div>
